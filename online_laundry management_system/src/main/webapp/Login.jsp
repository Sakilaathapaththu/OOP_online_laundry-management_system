        ...
        <div class="col-md-6">
            <div class="card">
                <form action="#" method="post" class="box">
                    ...
                    <h1>Login</h1>
                    <p class="text-muted">  <font color="lightPink">  Please Enter Admin Username and Password </font> </p> <br> 
                    
             
                    <input type="text" name="ausername"  placeholder="Enter your Username"> 
					<input type="password" name="apassword" placeholder="Enter your Password"> 
                    <a href="insertlaundry.jsp"><input type="button" name="submit" value="Login"></a> <br>
