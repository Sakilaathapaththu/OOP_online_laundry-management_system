...
@WebServlet("/insertoderservlet")
public class insertoderservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue=laundryDbutill.insertoder(lname, laddress, lTelephone, lNIC, lamount, duedate, returndate);
